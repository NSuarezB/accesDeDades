...
public class LectorXML {
	 ...
	 ArrayList<comanda> arrayComan2 = new ArrayList<comanda>();
	 ArrayList<lineaComanda> lineaComanPR = new ArrayList<lineaComanda>();
      ...
      try {
         ...
         ArrayList<lineaComanda> arrayLiniaComan2 = new ArrayList<lineaComanda>();
            ...
            if (nNode.getNodeType() == Node.ELEMENT_NODE ) {
                ...
                id_Client=Integer.parseInt(eElement.getAttribute("id_client"));
                ...
                statusAl=Integer.parseInt(eElement.getAttribute("status"));
               ...
               Node aNode = aList.item(temp2);
                  ...
                  if (aNode.getNodeType() == Node.ELEMENT_NODE ) {
                      ...
                      status=aElement.getElementsByTagName("status").item(0).getTextContent().charAt(0);
                       ...
                       idTemp=temp2+1;
                      arrayLiniaComan2.add(new lineaComanda(temp2+1,id_comanda,id_Artic,quantitat,unitatServ));
                      }
            ...
            if(statusAl==0) {  
          		...
          		//lineaComanda.add(new lineaComanda(idTemp,id_comanda,id_Artic,quantitat,unitatServ));
          		arrayComan2.add(new comanda(id_Client,id_comanda,preu,0));
            }
	 ...
	 public ArrayList<comanda> getArrayComan2() {
		return arrayComan2;
	}
