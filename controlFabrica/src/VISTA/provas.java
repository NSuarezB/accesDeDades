...
public class provas extends JFrame {
   ...
   /* private void leerDatos() throws ClassNotFoundException, SQLException {
    ...
    public provas() throws IOException {
        ...
        btnSave.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent arg0) {
        		...
        		if (idClie!="" && cp!=0 && nom!="" && persoContac!="" && local!="") {
        ...
        try {
            ...
            /*while(resultados.next() == true) {
                ...
                idClient = resultados.getString("idClient");
                name = resultados.getString("name");
                personaContacte = resultados.getString("personaContacte");
                localitzacio = resultados.getString("localitzacio");
                codiPostal = resultados.getInt("codiPostal");
                morositat = resultados.getInt("morositat");
                
                modelo.addRow( new Object[] {idClient, name, personaContacte, localitzacio, morositat} );                
            }*/
