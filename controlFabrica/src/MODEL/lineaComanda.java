...
public class lineaComanda{
	...
	public lineaComanda(int idLineaComanda,int idArticle,int idComanda,int quantitat,float preuUn,char status,int unitatsServides) {
	...
	public String toString() {
		return "\nlineaComanda [idLineaComanda=" + idLineaComanda + ", idArticle=" + idArticle + ", idComanda="
				+ idComanda + ", quantitat=" + quantitat + ", preuUn=" + preuUn + "€, preuLinia="+ getPreulinia() +"€, status=" + status +", Unitats servides="+unitatsServides +"]";
